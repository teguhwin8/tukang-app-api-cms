...
const actions = {
  ...
  setWhatsapp({ commit }, value) {
    commit('setWhatsapp', value)
  },
  ...
  insertGaleryFile({ commit }, file) {
    commit('insertGaleryFile', file)
  },
  removeGaleryFile({ commit }, file) {
    commit('removeGaleryFile', file)
  },
...
const mutations = {
  ...
  insertGaleryFile(state, file) {
    state.entry.galery.push(file)
  },
  removeGaleryFile(state, file) {
    state.entry.galery = state.entry.galery.filter(item => {
      return item.id !== file.id
    })
  },
